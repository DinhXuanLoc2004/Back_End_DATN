...
router.post('/create_order', OrderMiddleWare.checkProductForCreateOrder, asyncHandler(OrderController.createOrder))
...
router.put('/continue_order', OrderMiddleWare.checkProductForContinueOrder, asyncHandler(OrderController.continueOrder))
