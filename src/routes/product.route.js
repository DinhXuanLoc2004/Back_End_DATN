...
const { upload, uploadImageMiddleware, uploadOldImages, mergeImages, } = require('../middlewares/uploadfile.middleware')
const { asyncHandler } = require('../utils')
const ProductController = require('../controller/product.controller')
const router = express.Router()

router.post('/add_product', upload.array(['images']), uploadImageMiddleware,
...
router.post('/update_product', upload.array(['images']), uploadImageMiddleware, mergeImages,
